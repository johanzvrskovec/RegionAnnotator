...
#sh TIEFighter.sh
#or
#sh TIEFighter.sh -help

#Load the database with gene data. One file. If .txt we need to specify the input format.
#sh TIEFighter.sh -input "inputGene/gencode.genes.txt" -gene -iformat TSV
...
#sh TIEFighter.sh -input inputReference -reference -iformat TSV
...
#sh TIEFighter.sh -input "input/pgcscz3.txt" -iformat TSV -timeout 60000
